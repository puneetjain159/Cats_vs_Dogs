...
class Vgg16BN():
    ...
    def __init__(self, size=(224, 224), n_classes=2, lr=0.001,ft=True, batch_size=64,weights_file ='vgg16_bn.h5'):
        self.weights_file = weights_file  # download from: http://www.platform.ai/models/
        self.size = size
    ...
    def build(self,ft = True):
        ...
        self.FCBlock(Neuron=2048)
        self.FCBlock(Neuron=1024)
    ...
    def compile(self):
        self.model.compile(optimizer=Adadelta(lr=self.lr),
    ...
    def fit(self, trn_path, val_path, nb_trn_samples, nb_val_samples, nb_epoch=1, callbacks=None, aug=False):
        ...
        self.model.fit_generator(trn_gen, samples_per_epoch=nb_trn_samples, nb_epoch=nb_epoch, verbose=1,
